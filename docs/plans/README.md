...
| # | Plan | Waves | Status |
|---|---|---|---|
| 1 | [RBAC v2 — configurable roles & permissions](./rbac-v2-configurable-roles.md) | 4 | Waves 1-2 committed (`d7607731`, `2a47d639`); Wave 3 built (awaiting coordinator commit); Wave 4 not started |
