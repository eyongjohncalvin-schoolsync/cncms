...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | French translation of lang/en/validation.php — kept key-for-key
    | identical to Laravel's stock English file so App::setLocale('fr')
    | resolves every validation message without falling back to English.
    | Genuine French, not machine-translated.
    |
    */
    ...
    'contains' => 'Le champ :attribute doit contenir une valeur requise manquante.',
    ...
    'password' => [
        ...
        'uncompromised' => "Le :attribute indiqué a été trouvé dans une fuite de données. Veuillez choisir un(e) autre :attribute.",
    ],
    ...
    'uploaded' => "Échec de l'envoi du fichier :attribute.",
